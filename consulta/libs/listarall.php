	...
	<script type="text/javascript" language="javascript" src="js/jslistadoall.js"></script>
	
	
	<table class="table table-bordered table-condensed" id="tabla_lista_all">
	<thead>
	<tr class="success">
	<th>ID</th>
	<th>RESP. TICKET</th>
	...
	t.tck_tipo=ta.codigoactividad  where a.ate_estado like '03' ",$link);
	?>
