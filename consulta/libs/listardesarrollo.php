	...
	<script type="text/javascript" language="javascript" src="js/jslistadodesarrollo.js"></script>
	
	
	<table class="table table-bordered table-condensed" id="tabla_lista_desarrollo">
	<thead>
	<tr class="success">
	<th>ID</th>
	<th>RESP. TICKET</th>
	...
	t.tck_tipo=ta.codigoactividad  where a.ate_estado like '02' AND 
