...
<script type="text/javascript" language="javascript" src="js/jslistadoseguimiento.js"></script>


<table class="table table-bordered table-condensed" id="tabla_lista_seguimiento">
<thead>
<tr class="success">
<th>ID TICKET.</th>
<th>USUARIO</th>
...
user.id_usuario='$IDUSUARIO' AND 
	ta.codigoactividad not like '31'",$link);
?>
