	...
	<script type="text/javascript" language="javascript" src="js/jslistadosolicitud.js"></script>
	
	
	<table class="table table-bordered table-condensed" id="tabla_lista_solicitud">
	<thead>
	<tr class="success">
	<th>ID</th>
	<th>RESP. TICKET</th>
	...
	t.tck_detalle,est.est_descripcion AS estados,
	...
	t.tck_tipo=ta.codigoactividad  where  ta.codigoactividad='31' ",$link);
	?>
	...
	?>
	<tr >
	<td><a href="../pages/actualizar-atencion?idticket=<?php echo $reg[ate_tck_id];?>">
	...
	<td class="500"><?php echo $reg[tck_detalle]; ?></td>
	<td class="500"><?php echo $reg[ate_detalle]; ?></td>
