...
$sql="SELECT count(*) as cantidad,ar.alias from atencion as a  inner join ticket  as t on 	a.ate_tck_id=t.tck_id  inner join   webnets_rdgdb.usuario as  u  on
...
group by  ar.alias  order by count(*) desc";
$res=mysql_query($sql);
