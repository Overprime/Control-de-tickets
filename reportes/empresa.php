...
$sql2="SELECT fecha from validarfecha where usuario=$IDUSUARIO and tipo='empresa' ";
...
<form action="../actualizar/fecha-grafico-empresa.php" method="post">
...
<?php 
$var='2015-02';
$sql="SELECT emp.nombreempresa,count(*)as cantidad,(count(*)*100/
...
ate_horaestado like '%$fecha%')) as porc from atencion as a  inner join ticket  as t on
	...
	t.tck_tipo=ta.codigoactividad  where a.ate_estado like '03' and
ate_horaestado like '%$fecha%'
group by emp.nombreempresa  order by emp.nombreempresa;
...
<iframe src="/sistemas/graficos/pie-empresas.php" width="600" height="500"
